...
M.ui = {
   ...
   -- Enable this only if your terminal has the colorscheme set which you uses
   -- For Ex : if you have onedark set in config , set onedark's bg color on your terminal
   transparency = false,
}
...
M.options = {
   ...
   updatetime = 250,
   -- used for updater
   update_url = "https://github.com/saifulapm/nvim",
   update_branch = "main",
}
